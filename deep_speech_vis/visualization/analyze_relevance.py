...
class relevance_analyzer(object):
    ...
    def __init__(self, results, weights, biases, epoch_id, relevance_method, epsilon_value, alpha_value, pixel_scaling_factor, extension, image_dir):

        self.image_dir = image_dir
        self.pixel_scaling_factor = pixel_scaling_factor
